...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_with_empty_id(self):
        """It should raise DataValidationError if update is called with empty ID"""
        product = Product(name="Test Product", description="Test Description", price=10.0)
        product.id = None  # Ensure the ID is None
    ...
    def test_deserialize_missing_attribute(self):
        """It should raise DataValidationError for missing required attributes"""
        product = Product()
        data = {
            "description": "Test Description",
            "price": "10.0",
